...
public class DungeonsAnimationsPiglinModel extends AnimatedGeoModel {
    @Override
    ...
    public ResourceLocation getTextureResource(Object object) {
        return object instanceof PiglinBrute ?
                        new ResourceLocation(MODID, "textures/geo_entity/piglin/netherite_armored_piglin.png") :
                        new ResourceLocation(MODID,"textures/geo_entity/piglin/piglin.png");
    }
