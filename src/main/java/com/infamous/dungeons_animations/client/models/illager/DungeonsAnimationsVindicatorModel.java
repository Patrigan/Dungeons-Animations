...
public class DungeonsAnimationsVindicatorModel extends AnimatedGeoModel {
    @Override
    ...
    public ResourceLocation getTextureResource(Object object) {
        return object instanceof ArmoredVindicator ?
                ((ArmoredVindicator)object).isDiamond() ?
                        new ResourceLocation(MODID, "textures/geo_entity/illager/diamond_armored_vindicator.png"):
                        ((ArmoredVindicator)object).isGold() ?
                                new ResourceLocation(MODID, "textures/geo_entity/illager/gold_armored_vindicator.png"):
                                new ResourceLocation(MODID, "textures/geo_entity/illager/iron_armored_vindicator.png"):
                new ResourceLocation(MODID, "textures/geo_entity/illager/vindicator.png");
    }

    @Override
    public ResourceLocation getAnimationResource(Object animatable) {
        return new ResourceLocation(MODID, "animations/vindicator_geo.animation.json");
    }
}
