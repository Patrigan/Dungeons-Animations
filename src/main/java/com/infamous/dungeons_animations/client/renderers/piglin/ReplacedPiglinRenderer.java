...
import com.infamous.dungeons_animations.client.models.piglin.DungeonsAnimationsPiglinModel;
import com.infamous.dungeons_animations.client.renderers.geo.ModGeoReplacedEntityRenderer;
import com.infamous.dungeons_animations.entities.animation.piglin.PiglinAnimation;
...
public class ReplacedPiglinRenderer extends ModGeoReplacedEntityRenderer<PiglinAnimation> {

    public ReplacedPiglinRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DungeonsAnimationsPiglinModel(),
                new PiglinAnimation()
        );
    }
