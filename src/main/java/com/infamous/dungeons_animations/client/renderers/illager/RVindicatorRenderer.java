...
public class RVindicatorRenderer extends ModGeoReplacedEntityRenderer<VindicatorAnimation> {

    public RVindicatorRenderer(EntityRendererProvider.Context renderManager) {
