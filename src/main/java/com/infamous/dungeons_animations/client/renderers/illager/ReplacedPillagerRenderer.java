...
import com.infamous.dungeons_animations.client.models.illager.DungeonsAnimationsPillagerModel;
import com.infamous.dungeons_animations.client.renderers.geo.ModGeoReplacedEntityRenderer;
import com.infamous.dungeons_animations.entities.animation.PillagerAnimation;
...
public class ReplacedPillagerRenderer extends ModGeoReplacedEntityRenderer<PillagerAnimation> {

    public ReplacedPillagerRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DungeonsAnimationsPillagerModel(),
