...
public class REvokerRenderer extends ModGeoReplacedEntityRenderer<EvokerAnimation> {

    public REvokerRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DAEvokerModel(),
                new EvokerAnimation()
        );
    }
