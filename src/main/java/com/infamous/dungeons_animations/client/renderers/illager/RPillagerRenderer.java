...
import com.infamous.dungeons_animations.client.models.illager.DAPillagerModel;
...
import com.infamous.dungeons_animations.entities.minecraft_dungeons_animation.PillagerAnimation;
...
public class RPillagerRenderer extends ModGeoReplacedEntityRenderer<PillagerAnimation> {

    public RPillagerRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DAPillagerModel(),
                new PillagerAnimation()
        );
    }
