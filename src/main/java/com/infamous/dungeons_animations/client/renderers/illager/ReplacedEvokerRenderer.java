...
import com.infamous.dungeons_animations.client.models.illager.DungeonsAnimationsEvokerModel;
import com.infamous.dungeons_animations.client.renderers.geo.ModGeoReplacedEntityRenderer;
import com.infamous.dungeons_animations.entities.animation.EvokerAnimation;
...
public class ReplacedEvokerRenderer extends ModGeoReplacedEntityRenderer<EvokerAnimation> {

    public ReplacedEvokerRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DungeonsAnimationsEvokerModel(),
                new EvokerAnimation()
        );
    }
