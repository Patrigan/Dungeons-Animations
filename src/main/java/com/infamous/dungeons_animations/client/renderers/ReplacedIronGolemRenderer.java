package com.infamous.dungeons_animations.client.renderers;

import com.infamous.dungeons_animations.client.models.DungeonsAnimationsIronGolemModel;
import com.infamous.dungeons_animations.client.renderers.geo.ModGeoReplacedEntityRenderer;
import com.infamous.dungeons_animations.entities.animation.IronGolemAnimation;
...
public class ReplacedIronGolemRenderer extends ModGeoReplacedEntityRenderer<IronGolemAnimation> {

    public ReplacedIronGolemRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DungeonsAnimationsIronGolemModel(),
                new IronGolemAnimation()
        );
    }
