...
import com.infamous.dungeons_animations.client.models.illager.DungeonsAnimationsVindicatorModel;
import com.infamous.dungeons_animations.client.renderers.geo.ModGeoReplacedEntityRenderer;
import com.infamous.dungeons_animations.entities.animation.VindicatorAnimation;
...
public class ReplacedVindicatorRenderer extends ModGeoReplacedEntityRenderer<VindicatorAnimation> {

    public ReplacedVindicatorRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DungeonsAnimationsVindicatorModel(),
                new VindicatorAnimation()
        );
    }
